<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ETicket.aspx.cs" Inherits="AirWebService.ETicket.ETicket" %>
...
<body>
    <div style="margin:0 auto; width:800px;font-family:dotum, '돋움', Helvetica,Arial,sans-serif;">
        ...
        <div style="border-bottom:3px solid #006f54; overflow:hidden;">
			<h1 style="margin:0; float:left; height:50px; font-size:14px; color:#000;"><asp:Literal ID="ltrLogo" runat="server" /><br /><p style="padding-top:7px;"><asp:Literal ID="ltrAgentInfo" runat="server" /></p></h1>
		...
		<div style="margin:10px 0;">
			<table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size:12px; border:1px solid #ddd;">
				...
				<tbody>
					<tr>
						<th scope="row" style="padding:5px; text-align:left; background-color:#f2f2f2;">탑승객 영문명(성/이름) <span style="font-weight:normal; font-size:12px; color:#818181;">(Passenger Name)</span></th>
						<td style="padding:0 5px; border-left:1px solid #ddd;"><strong><asp:Literal ID="ltrPaxName" runat="server" /></strong> (MR/MS/MSTR/MISS : ※ 성별 및 유아 아동 표기)</td>
					</tr>
					<tr>
						<th scope="row" style="padding:5px; text-align:left; border-top:1px solid #ddd; background-color:#f2f2f2;">항공권 번호 <span style="font-weight:normal; font-size:12px; color:#818181;">(Ticket Number)</span></th>
						<td style="padding:0 5px; border-top:1px solid #ddd; border-left:1px solid #ddd;"><strong><asp:Literal ID="ltrTicketNumber" runat="server" /></strong> (해당 항공권번호로 항공사에 티켓 확인 가능)</td>
					</tr>
					<tr>
						...
						<table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size:12px; border:1px solid #ddd;">
							...
							<tbody>
								...
								<tr>
									...
									<td style="padding:3px 5px 1px; font-weight:bold; color:#818181;"><%#XPath("fare/@basis")%></td>
									...
									<td style="padding:3px 5px 1px; font-weight:bold; color:#818181;"><%#cm.AbacusDateTime(XPath("fare/@nvb").ToString())%></td>
								</tr>
								<tr>
									<th scope="row" style="padding:3px 5px 1px; font-weight:normal; text-align:left;">좌석 <span style="font-weight:normal; color:#818181;">(Seat Number)</span></th>
									<td style="padding:3px 5px 1px; font-weight:bold; color:#818181;"><%#XPath("fare/@seat")%></td>
									...
									<td style="padding:3px 5px 1px; font-weight:bold; color:#818181;"><%#cm.AbacusDateTime(XPath("fare/@nva").ToString())%></td>
								</tr>
								<tr>
									...
									<td style="padding:3px 5px 1px; font-weight:bold;"></td>
									<td style="padding:3px 5px 1px; font-weight:bold; color:#818181;"><%#XPath("fare/@baggage")%></td>
								</tr>
							</tbody>
						</table>
		...
		<div style="margin:10px auto;">
			<h3 style="margin:7px 0 5px; font-weight:bold; font-size:14px; line-height:normal; color:#333; text-align:left;">■ e-항공권 운임정보<span style="font-weight:normal; color:#818181;">(Ticket/Fare Information)</span></h3>
			<p style="margin:5px 0 3px; font-weight:bold; font-size:12px; height:17px; line-height:17px; "><span style="float:left;"><img src="//img.modetour.co.kr/ModeLiveBooking/130913_air/ico/bu_gray_dot.gif" alt="" style="vertical-align: middle;"/> 항공권 운임(Ticket/Fare)</span><span style="float:right; margin-top:5px; font-weight:normal; font-size:8pt; color:#333;">[단위 : <asp:Literal ID="ltrCurrency" runat="server" />]</span></p>
			<div style="margin:0;padding:0;">
				<table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size:12px; border:1px solid #ddd;">
					<thead>
						<tr>
							<th scope="col" style="margin:0;padding:5px 0;text-align:center;background-color:#f2f2f2;border-bottom:1px solid #ddd;">항공운임<span style="font-weight:normal; color:#818181;">(Prices)</span></th>
							<th scope="col" style="margin:0;padding:5px 0;text-align:center;background-color:#f2f2f2;border-left:1px solid #ddd;border-bottom:1px solid #ddd;">세금<span style="font-weight:normal; color:#818181;">(Taxes)</span></th>
							<th scope="col" style="margin:0;padding:5px 0;text-align:center;background-color:#f2f2f2;border-left:1px solid #ddd;border-bottom:1px solid #ddd;">유류할증료<span style="font-weight:normal; color:#818181;">(Fuel Surcharge)</span></th>
							<th scope="col" style="margin:0;padding:5px 0;text-align:center;background-color:#f2f2f2;border-left:1px solid #ddd;border-bottom:1px solid #ddd;">부가수수료<span style="font-weight:normal; color:#818181;">(Service Fees)</span></th>
							<th scope="col" style="margin:0;padding:5px 0;text-align:center;background-color:#f2f2f2;border-left:1px solid #ddd;border-bottom:1px solid #ddd;">총 지불금액<span style="font-weight:normal; color:#818181;">(Total Amount)</span></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td style="margin:0;padding:5px 0;color:#333;text-align:center;"><asp:Literal ID="ltrFare" runat="server" /></td>
							<td style="margin:0;padding:5px 0;color:#333;border-left:1px solid #ddd;text-align:center;"><asp:Literal ID="ltrTax" runat="server" /></td>
							<td style="margin:0;padding:5px 0;color:#333;border-left:1px solid #ddd;text-align:center;"><asp:Literal ID="ltrFsc" runat="server" /></td>
							<td style="margin:0;padding:5px 0;color:#333;border-left:1px solid #ddd;text-align:center;"><asp:Literal ID="ltrTasf" runat="server" /></td>
							<td style="margin:0;padding:5px 0;color:#333;border-left:1px solid #ddd;text-align:center;"><asp:Literal ID="ltrAmount" runat="server" /></td>
						</tr>
					</tbody>
				</table>
			</div>
			<p style="margin:5px 0 3px; font-weight:bold; font-size:12px; height:17px; line-height:17px; "><img src="//img.modetour.co.kr/ModeLiveBooking/130913_air/ico/bu_gray_dot.gif" alt="" style="vertical-align: middle;"/> 지불수단(Form Of Payment): <asp:Literal ID="ltrPayment" runat="server" /></p>
		</div>
        <%}%>
        <%if (!SimpleTicket) {%>
        <div>
        ...
        <%if (SiteNum.Equals(2) || SiteNum.Equals(3915) || SiteNum.Equals(4638) || SiteNum.Equals(4664) || SiteNum.Equals(4837)) {%>
        <div>
            <a href="http://www.modetour.com/event/event_19/10036/mode.aspx" target="_blank"><img src="//img.modetour.co.kr/modetour/2015/naver/ban_201806_mail.png" alt="해외호텔7%할인" style="vertical-align: middle;border:0;width:800px;height:110px;"/></a>
        </div>
        <%}%>
        <div>
