...
namespace AirWebService
{
	...
	public class AirService3 : System.Web.Services.WebService
	{
        ...
        {
            string SXL = "<itinerary><segGroup ref=\"A00ADTM1005\" ejt=\"0110\" eft=\"0110\" ewt=\"\" mjc=\"OZ\" cds=\"N\" nosp=\"0\" iti=\"ICN/WEH/201909011620/201909011630/0110/0110//OZ/0/0/N\" rtg=\"ICN/WEH\" aif=\"\" fiRef=\"1\"><seg dlc=\"ICN\" alc=\"WEH\" ddt=\"2019-09-01 16:20\" ardt=\"2019-09-01 16:30\" eft=\"0110\" ett=\"\" gwt=\"\" mcc=\"OZ\" occ=\"OZ\" cds=\"N\" fln=\"309\" stn=\"0\" etc=\"Y\" aif=\"\" /></segGroup><segGroup ref=\"A00ADTM2006\" ejt=\"0110\" eft=\"0110\" ewt=\"\" mjc=\"OZ\" cds=\"N\" nosp=\"0\" iti=\"WEH/ICN/201909071010/201909071220/0110/0110//OZ/0/0/N\" rtg=\"WEH/ICN\" aif=\"\" fiRef=\"2\"><seg dlc=\"WEH\" alc=\"ICN\" ddt=\"2019-09-07 10:10\" ardt=\"2019-09-07 12:20\" eft=\"0110\" ett=\"\" gwt=\"\" mcc=\"OZ\" occ=\"OZ\" cds=\"N\" fln=\"310\" stn=\"0\" etc=\"Y\" aif=\"\" /></segGroup></itinerary>";
            string FXL = "<paxFareGroup ref=\"A00ADTMB001\" gds=\"Amadeus\" ptc=\"ADT\" mode=\"\"><summary price=\"234100\" subPrice=\"224100\" fare=\"185000\" disFare=\"166500\" tax=\"43400\" fsc=\"14200\" disPartner=\"0\" tasf=\"10000\" mTasf=\"10000\" aTasf=\"0\" pvc=\"OZ\" mas=\"3M\" cabin=\"M\" ttl=\"2019-08-29\" cds=\"N\" cff=\"Y\" ttf=\"Y\" sutf=\"N\" pmcd=\"475440\" pmtl=\"성인/삼성카드할인\" pmsc=\"01\" pmsn=\"삼성\" sscd=\"\" sstl=\"\" /><paxFare ptc=\"ADT\" price=\"234100\" fare=\"185000\" disFare=\"166500\" tax=\"43400\" fsc=\"14200\" disPartner=\"0\" tasf=\"10000\" mTasf=\"10000\" aTasf=\"0\" count=\"1\"><segFare ref=\"1\">1^3M^SLKCS^ADT^^S^M^3^^Y^RA</segFare><segFare ref=\"2\">1^3M^KLKCS^ADT^^K^M^6^^Y^RA</segFare></paxFare><promotionInfo>475440^3915^OZ^RT^^^Y^^^^0.0000^0.0000^0.0000^0.1000^ADT0120^삼성카드 할인^01^삼성^성인/삼성카드할인^N^^^Y^N^3^201912311700</promotionInfo></paxFareGroup>";

            return SearchRuleRS(3915, "", SXL, FXL, "", "AHB03-201908261107442562", "MOBILEWEB");
        }
        ...
        /// <param name="DLC">출발지 공항 코드</param>
        /// <param name="ALC">도착지 공항 코드</param>
        /// <param name="DTD">출발일(YYMMDD)</param>
        /// <param name="CCD">캐빈 클래스(Y:Economic, M:Economic Standard, W:Economic Premium, C:Business, F:First/Supersonic)</param>
        /// <param name="ROT">구간(OW:편도, RT:왕복, MD:다구간) :: RT 고정</param>
        /// <param name="RQT">요청단말기(WEB/MOBILEWEB/MOBILEAPP/CRS/MODEWARE)</param>        
        /// <returns></returns>
        [WebMethod(Description = "MPIS 최저가요금 리스트")]
        public XmlElement SearchLowPriceRS(int SNM, string DLC, string ALC, string DTD, string CCD, string ROT, string RQT)
        {
            int ServiceNumber = 692;
            string LogGUID = cm.GetGUID;

            try
            {
                if ("/SEL/ICN/GMP".IndexOf(DLC) != -1)
                {
                    DTD = cm.Right(DTD.Replace("-", ""), 6);
                    CCD = (CCD.Equals("Y") || CCD.Equals("W")) ? "M" : CCD;
                    ...
                    using (SqlCommand cmd = new SqlCommand())
                    {
                        ...
                        {
                            using (DataSet ds = new DataSet("LowPriceInfo"))
                            {
                                cmd.Connection = new SqlConnection(ConfigurationManager.ConnectionStrings["WSVMPIS"].ConnectionString);
                                cmd.CommandTimeout = 10;
                                cmd.CommandType = CommandType.StoredProcedure;
                                cmd.CommandText = "WSVMPIS.DBO.WSV_S_해외항공_최저가_조회";

                                cmd.Parameters.Add("@사이트번호", SqlDbType.Int, 0);
                                cmd.Parameters.Add("@검색조건", SqlDbType.Char, 15);

                                cmd.Parameters["@사이트번호"].Value = SNM;
                                cmd.Parameters["@검색조건"].Value = String.Concat(ROT, DLC, ALC, DTD, CCD);
                    ...
                    throw new Exception("SEL/ICN/GMP 출발공항에 대해서만 검색이 가능합니다.");
            }
            catch (Exception ex)
            {
        ...
        {
            int SNM = 2;
            string FXL = "<paxFareGroup ref=\"A00ADTMA001\" gds=\"Amadeus\" ptc=\"ADT\" mode=\"\">  <summary price=\"233700\" subPrice=\"223700\" fare=\"158000\" disFare=\"158000\" tax=\"46900\" fsc=\"18800\" disPartner=\"0\" tasf=\"10000\" mTasf=\"10000\" aTasf=\"0\" pvc=\"ZE\" mas=\"1Y\" cabin=\"M\" ttl=\"2019-11-01\" cds=\"N\" cff=\"Y\" ttf=\"Y\" sutf=\"N\" pmcd=\"\" pmtl=\"\" pmsc=\"\" pmsn=\"\" sscd=\"\" sstl=\"\" />  <paxFare ptc=\"ADT\" price=\"233700\" fare=\"158005\" disFare=\"158000\" tax=\"46900\" fsc=\"18800\" disPartner=\"0\" tasf=\"10000\" mTasf=\"10000\" aTasf=\"0\" count=\"1\">    <segFare ref=\"1\">1^1Y^TOW^ADT^^T^M^3^^Y^RN,MSP</segFare>    <segFare ref=\"2\">1^1Y^IOW^ADT^^I^M^2^^Y^RN,MSP</segFare>  </paxFare></paxFareGroup>";
            string SXL = "<itinerary>  <segGroup ref=\"A00ADTM1001\" ejt=\"0500\" eft=\"0500\" ewt=\"\" mjc=\"ZE\" cds=\"N\" nosp=\"0\" iti=\"ICN/CXR/201912081105/201912081405/0500/0500//ZE/0/0/N\" rtg=\"ICN/CXR\" aif=\"\" fiRef=\"1\">    <seg dlc=\"ICN\" alc=\"CXR\" ddt=\"2019-12-08 11:05\" ardt=\"2019-12-08 14:05\" eft=\"0500\" ett=\"\" gwt=\"\" mcc=\"ZE\" occ=\"ZE\" cds=\"N\" fln=\"563\" stn=\"0\" etc=\"Y\" aif=\"\" />  </segGroup>  <segGroup ref=\"A00ADTM2001\" ejt=\"0425\" eft=\"0425\" ewt=\"\" mjc=\"ZE\" cds=\"N\" nosp=\"0\" iti=\"CXR/ICN/201912130105/201912130730/0425/0425//ZE/0/0/N\" rtg=\"CXR/ICN\" aif=\"\" fiRef=\"2\">    <seg dlc=\"CXR\" alc=\"ICN\" ddt=\"2019-12-13 01:05\" ardt=\"2019-12-13 07:30\" eft=\"0425\" ett=\"\" gwt=\"\" mcc=\"ZE\" occ=\"ZE\" cds=\"N\" fln=\"562\" stn=\"0\" etc=\"Y\" aif=\"\" />  </segGroup></itinerary>";
        ...
        /// <param name="FXL">요금조회 결과 중 선택된 paxFareGroup XmlNode</param>
        ...
        public XmlElement CheckSelectFareRS(int SNM, string FXL, string SXL, string RQT)
        {
            ...
            try
            {
                ...
                {
                    int n = 0;
                    int FiRef = Convert.ToInt32(SegGroup.Attributes.GetNamedItem("fiRef").InnerText);
                    string[] SegFare = XmlFare.SelectSingleNode(String.Format("paxFareGroup/paxFare/segFare[@ref='{0}']", FiRef)).InnerText.Split('/');

                    foreach (XmlNode Seg in SegGroup.SelectNodes("seg"))
                    {
                        string[] SegFareLeg = SegFare[n].Split('^');
                        ...
                        StrFareType += String.Concat(SegFareLeg[10], ",");
                ...
                foreach (string FareType in StrFareType.Split(','))
                {
                    if (FareType.Equals("RP"))
                        FareTypeRP++;
                    else if (FareType.Equals("RB") || FareType.Equals("RC") || FareType.Equals("RX") || FareType.Equals("RZ"))
                        FareTypeRW++;
                    else
                        FareTypeRU++;
                }
                ...
                //탑승객
                foreach (XmlNode PaxFare in XmlFare.SelectNodes("paxFareGroup/paxFare"))
                {
                    int PaxCount = Convert.ToInt32(PaxFare.Attributes.GetNamedItem("count").InnerText);
                ...
                //프로모션
                string PMID = (XmlFare.SelectNodes("paxFareGroup/promotionInfo").Count > 0) ? XmlFare.SelectSingleNode("paxFareGroup/promotionInfo").InnerText.Split('^')[0] : "";

                //운임조회
                XmlElement ResXml = asv.SearchFareWithoutPNR(SNM, PMID, FAT, INO, DTD, DTT, ARD, ART, DLC, ALC, MCC, OCC, FLN, RBD, PTC, NOP, LogGUID);
                ...
                //운임 비교
                if (XmlFare.SelectNodes("paxFareGroup/paxFare").Count.Equals(ResXml.SelectNodes("paxFareGroup/paxFare").Count))
                {
                    foreach (XmlNode oPaxFare in XmlFare.SelectNodes("paxFareGroup/paxFare"))
                    {
                        ...
                        if (oPaxFare.Attributes.GetNamedItem("fare").InnerText != PaxFare.Attributes.GetNamedItem("fare").InnerText)
                        {
                        ...
                        {   
                            if (oPaxFare.Attributes.GetNamedItem("tax").InnerText != PaxFare.Attributes.GetNamedItem("tax").InnerText)
                            {
                            ...
                            {
                                if (oPaxFare.Attributes.GetNamedItem("fsc").InnerText != PaxFare.Attributes.GetNamedItem("fsc").InnerText)
                                {
        ...
        public XmlElement FXLDowngrade(string FXL, string FREF, string FGID, string RQT)
        {
            ...
            try
            {
                ...
                {
                    FXL = "<paxFareGroup ref=\"A00ADTMB001\" mode=\"\" ptc=\"ADT\" adtPrice=\"331600\" gds=\"Amadeus\"><summary price=\"331600\" subPrice=\"321600\" fare=\"230000\" disFare=\"217800\" tax=\"59800\" fsc=\"44000\" disPartner=\"0\" tasf=\"10000\" mTasf=\"10000\" aTasf=\"0\" pvc=\"VN\" mas=\"1Y\" cabin=\"M\" ttl=\"2019-08-16\" cds=\"N\" cff=\"Y\" ttf=\"Y\" sutf=\"N\" pmsc=\"01\" pmsn=\"삼성\" pmcd=\"482013\" pmtl=\"성인/삼성카드할인\" sscd=\"\" sstl=\"\"/><paxFare ptc=\"ADT\" price=\"331600\" fare=\"230000\" disFare=\"217800\" tax=\"59800\" fsc=\"44000\" disPartner=\"0\" tasf=\"10000\" mTasf=\"10000\" aTasf=\"0\" count=\"1\"><segFare ref=\"1\">1^^RL1YKR^ADT^^R^M^4^^N^RP/2^1Y^RL1YKR^ADT^^Q^M^7^^Y^RP</segFare><segFare ref=\"2\">1^^TL1YKR^ADT^^Q^M^7^^N^RP/2^1Y^TL1YKR^ADT^^T^M^7^^Y^RP</segFare></paxFare><promotionInfo>482013^3915^VN^RT^^^Y^^^^0.0000^0.0000^0.0000^0.0530^ADT0120^삼성카드 할인^01^삼성^성인/삼성카드할인^N^^^N^N^3^201912311700</promotionInfo> </paxFareGroup>";
                    FREF = "6984";
                    FGID = "ITHV010-201908141405423021";
                }
        ...
        /// <returns></returns>
        [WebMethod(Description = "운임규정 조회")]
        public XmlElement SearchRuleRS(int SNM, string SAC, string SXL, string FXL, string FREF, string FGID, string RQT)
        {
            ...
            try
            {
                ...
                sqlParam[9].Value = SAC;
                sqlParam[10].Value = SXL;
                sqlParam[11].Value = FXL;
            ...
            try
            {
                ...
                return asv.SearchRuleRS(SNM, SAC, PMID, INO, DTD, DTT, ARD, ART, DLC, ALC, MCC, OCC, FLN, RBD, FXLDowngrade(FXL, FREF, FGID, RQT).SelectSingleNode("paxFareGroup").OuterXml);
            }
            catch (Exception ex)
            {
                return new MWSExceptionMode(ex, hcc, LogGUID, "AirService3", MethodBase.GetCurrentMethod().Name, ServiceNumber, 0, 0).ToErrors;
        ...
        public string SearchRuleARTRS(int SNM, string SXL, string FXL, string FREF, string FGID, string RQT)
        {
            ...
            string PMID = XmlFXL.SelectSingleNode("paxFareGroup/summary").Attributes.GetNamedItem("pmcd").InnerText;
            string SAC = XmlFXL.SelectSingleNode("paxFareGroup/summary").Attributes.GetNamedItem("pvc").InnerText;
            string PFG = String.Empty;
            ...
            return new TopasAirService().AutomatedRuleTranslatorRS(SNM, SAC, INO, DTD, DTT, ARD, ART, DLC, ALC, MCC, OCC, FLN, RBD, FXLDowngrade(FXL, FREF, FGID, RQT).SelectSingleNode("paxFareGroup").OuterXml, cm.GetGUID);
        }
