...
namespace AirWebService.DisplayTST
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/TTSTRQ_12_1_1A", ParameterStyle = SoapParameterStyle.Bare)]
