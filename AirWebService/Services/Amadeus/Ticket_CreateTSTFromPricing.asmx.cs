...
namespace AirWebService.CreateTSTFromPricing
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/TAUTCQ_04_1_1A", ParameterStyle = SoapParameterStyle.Bare)]
