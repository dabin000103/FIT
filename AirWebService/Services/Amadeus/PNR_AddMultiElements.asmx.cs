...
namespace AirWebService.AddMultiElements
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/PNRADD_12_2_1A", ParameterStyle = SoapParameterStyle.Bare)]
