...
namespace AirWebService.QueueRemoveItem
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
        ...
        [SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/QUQMDQ_03_1_1A", ParameterStyle = SoapParameterStyle.Bare)]
