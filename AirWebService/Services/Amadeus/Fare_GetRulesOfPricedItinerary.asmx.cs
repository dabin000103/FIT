...
namespace AirWebService.GetRulesOfPricedItinerary
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/TFRUDQ_12_1_1A", Use = SoapBindingUse.Literal, ParameterStyle = SoapParameterStyle.Bare)]
