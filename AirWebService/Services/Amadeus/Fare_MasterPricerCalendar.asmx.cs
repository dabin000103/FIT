...
namespace AirWebService.MasterPricerCalendar
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/FMPCAQ_12_2_1A", Use = SoapBindingUse.Literal, ParameterStyle = SoapParameterStyle.Bare)]
