...
namespace AirWebService.DisplayQuota
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/TTQSDQ_11_1_1A", ParameterStyle = SoapParameterStyle.Bare)]
