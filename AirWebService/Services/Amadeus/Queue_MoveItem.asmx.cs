...
namespace AirWebService.QueueMoveItem
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
        ...
        [SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/QUQMUQ_03_1_1A", ParameterStyle = SoapParameterStyle.Bare)]
