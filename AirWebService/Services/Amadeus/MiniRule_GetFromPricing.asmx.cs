...
namespace AirWebService.MiniRuleGetFromPricing
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/TMRCRQ_11_1_1A", Use = SoapBindingUse.Literal, ParameterStyle = SoapParameterStyle.Bare)]
