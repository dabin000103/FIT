...
namespace AirWebService.QueuePlacePNR
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
        ...
        [SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/QUQPCQ_03_1_1A", ParameterStyle = SoapParameterStyle.Bare)]
