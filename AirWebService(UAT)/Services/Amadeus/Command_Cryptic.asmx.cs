...
namespace AirWebService.CommandCryptic
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/HSFREQ_07_3_1A", ParameterStyle = SoapParameterStyle.Bare)]
