...
namespace AirWebService.MasterPricerTravelBoardSearch
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/FMPTBQ_13_3_1A", Use = SoapBindingUse.Literal, ParameterStyle = SoapParameterStyle.Bare)]
