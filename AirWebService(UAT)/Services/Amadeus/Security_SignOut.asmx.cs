...
namespace AirWebService.SignOut
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOTU/VLSSOQ_04_1_1A", Use = SoapBindingUse.Literal, ParameterStyle = SoapParameterStyle.Bare)]
