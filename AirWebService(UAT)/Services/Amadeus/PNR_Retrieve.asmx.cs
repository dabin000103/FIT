...
namespace AirWebService.Retrieve
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/PNRRET_12_2_1A", ParameterStyle = SoapParameterStyle.Bare)]
