...
namespace AirWebService.PricePNRWithBookingClassPricing
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/TPCBRQ_12_4_1A", Use = SoapBindingUse.Literal, ParameterStyle = SoapParameterStyle.Bare)]
