...
namespace AirWebService.SellByFareSearch
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/FSOTBQ_12_2_1A", Use = SoapBindingUse.Literal, ParameterStyle = SoapParameterStyle.Bare)]
