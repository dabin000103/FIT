...
namespace AirWebService.QueueList
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
        ...
        [SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/QDQLRQ_11_1_1A", ParameterStyle = SoapParameterStyle.Bare)]
