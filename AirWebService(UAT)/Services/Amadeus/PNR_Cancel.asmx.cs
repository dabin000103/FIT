...
namespace AirWebService.Cancel
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/PNRXCL_12_2_1A", ParameterStyle = SoapParameterStyle.Bare)]
