...
namespace AirWebService.ProcessEDoc
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/TATREQ_09_1_1A", ParameterStyle = SoapParameterStyle.Bare)]
