...
namespace AirWebService.CreateFormOfPayment
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/TFOPCQ_11_1_1A", ParameterStyle = SoapParameterStyle.Bare)]
