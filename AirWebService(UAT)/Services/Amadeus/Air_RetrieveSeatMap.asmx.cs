...
namespace AirWebService.RetrieveSeatMap
{
	/// <summary>
	...
	public class AmadeusWebService : SoapHttpClientProtocol
	{
		...
		[SoapDocumentMethodAttribute("http://webservices.amadeus.com/1ASIWIBEMOT/SMPREQ_97_1_IA", ParameterStyle = SoapParameterStyle.Bare)]
