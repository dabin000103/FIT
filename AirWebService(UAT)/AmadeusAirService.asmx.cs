...
namespace AirWebService
{
	...
	public class AmadeusAirService : System.Web.Services.WebService
	{
        ...
        [WebMethod(Description = "Fare_InstantTravelBoardSearchRS")]
        public XmlElement InstantTravelBoardSearchRSTEST(string GUID, int SNM, string SAC, string DLC, string ALC, string CLC, string ROT, string DTD, string ARD, string OPN, string FLD, string CCD, string[] PTC, int[] NOP, string ACQ, string FAB, string PUB, int WLR, string MTL, int NRR)
        {
            XmlElement ReqXml = InstantTravelBoardSearchRQ(SNM, SAC, DLC, ALC, CLC, ROT, DTD, ARD, OPN, FLD, CCD, PTC, NOP, ACQ, FAB, "", "", PUB, WLR, MTL, NRR);
            XmlElement ResXml = ac.HttpExecuteSoapHeader4TEST("InstantTravelBoardSearchTEST", "SELK138AB", ReqXml, GUID);
        ...
        public XmlElement AddMultiElementsTourCodeRQ(string PTC, string TourCode)
        {
            XmlDocument XmlDoc = new XmlDocument();
        ...
        public XmlElement AddMultiElementsTourCodeRS(string SID, string SQN, string SCT, string GUID, string PTC, string TourCode)
        {
            XmlElement ReqXml = AddMultiElementsTourCodeRQ(PTC, TourCode);
