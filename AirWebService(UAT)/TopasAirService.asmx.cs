...
namespace AirWebService
{
	...
	public class TopasAirService : System.Web.Services.WebService
	{
        ...
        public string AutomatedRuleTranslatorRQ(int SNM, int[] INO, string[] DTD, string[] DTT, string[] ARD, string[] ART, string[] DLC, string[] ALC, string[] MCC, string[] OCC, string[] FLN, string[] RBD, string PFG, string GUID)
        {
            XmlDocument XmlDoc = new XmlDocument();
            XmlDoc.LoadXml(PFG);
        ...
        public string AutomatedRuleTranslatorRS(int SNM, int[] INO, string[] DTD, string[] DTT, string[] ARD, string[] ART, string[] DLC, string[] ALC, string[] MCC, string[] OCC, string[] FLN, string[] RBD, string PFG, string GUID)
        {
            string ReqXml = AutomatedRuleTranslatorRQ(SNM, INO, DTD, DTT, ARD, ART, DLC, ALC, MCC, OCC, FLN, RBD, PFG, GUID);
