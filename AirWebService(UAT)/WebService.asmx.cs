...
namespace AirWebService
{
    ...
    public class WebService : System.Web.Services.WebService
    {
        ...
        public XmlElement SearchRuleRS(int SNM, string PMID, int[] INO, string[] DTD, string[] DTT, string[] ARD, string[] ART, string[] DLC, string[] ALC, string[] MCC, string[] OCC, string[] FLN, string[] RBD, string PFG)
        {
